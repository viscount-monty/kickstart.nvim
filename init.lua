...
require('lazy').setup({
  ...
  'tpope/vim-fugitive', -- Install git integration Fugitive
  ...
  -- Install tmux navigation plugin
  {
    ...
    config = function()
      ...
      -- Custom maps
      -- <leader>hjkl for pane navigation
      vim.keymap.set('n', '<leader>ph', nvim_tmux_nav.NvimTmuxNavigateLeft, { desc = 'Left' })
      vim.keymap.set('n', '<leader>pj', nvim_tmux_nav.NvimTmuxNavigateDown, { desc = 'Down' })
      vim.keymap.set('n', '<leader>pk', nvim_tmux_nav.NvimTmuxNavigateUp, { desc = 'Up' })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      vim.api.nvim_set_hl(0, '@markup.raw.markdown_inline', { bg = '', fg = '#7aa2f7' })
    end,
    opts = {
      ...
      -- dim_inactive = true,
      ['@markup.raw.block.markdown'] = '@markup.raw.markdown_inline',
    },
    -- config = function()
    -- Remove highlight from inline code in markdown
    -- vim.api.nvim_set_hl(0, '@markup.raw.markdown_inline', { bg = '', fg = '#7aa2f7'})
    -- end,
  },
