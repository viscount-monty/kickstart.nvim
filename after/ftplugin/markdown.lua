...
-- Links [Label](URL)
-- Brackets
-- vim.api.nvim_set_hl(0, '@markup.link.markdown_inline', { fg = '#00ff00', bold = false, bg = ''})

-- Label
-- vim.api.nvim_set_hl(0, '@markup.link.label.markdown_inline', { fg = '', bold = true, bg = ''})

-- URL
-- vim.api.nvim_set_hl(0, '@markup.link.url.markdown_inline', { fg = '#ff00ff', bold = false, bg = ''})
